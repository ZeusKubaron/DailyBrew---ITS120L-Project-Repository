...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media (max-width: 768px) {
        ...
        #calendar .fc-view-container { overflow-y: auto; overflow-x: hidden; }
        #calendar .fc-day-grid-container,
        #calendar .fc-time-grid-container { overflow-y: auto; overflow-x: hidden; }

        
        /* ── STRONG FULL-WIDTH FIX ── */
    ...
    <script>
        ...
        tasks.filter(t => t.status !== 'completed').forEach(task => {
            events.push({
                ...
                title: '📝 ' + task.title,
                start: task.dueDate,
                backgroundColor: task.aiPriority === 'high' ? '#8B3A3A' : task.aiPriority === 'medium' ? '#B89240' : '#4A7C59',
        ...
        schedule.forEach(s => {
            ...
            for (let week = 0; week < 8; week++) {
                ...
                events.push({
                    ...
                    backgroundColor: s.color || '#9D8A7C',
                    borderColor: 'transparent',
                    type: 'class'
                });
            }
